...
on-demand, wanneer gebruikers ze opvragen. In tegenstelling tot bij
statische sitegenerators en andere statische oplossingen, worden je build
times niet verhoogd, of je nu 10 of 10 miljoen afbeeldingen gebruikt.
...
- [Vercel](https://vercel.com): Werkt automatisch wanneer je deployt op
...
ze breedtes gedefinieerd in `deviceSizes`, omdat de arrays geconcateneerd
...
afbeelding niet even breedt zal zijn als de viewport.
